...
mongoose.connect('mongodb://localhost:27017/foodDelivery', {
    ...
    // Approve/Reject Users, Promote Restaurants
    ...
    app.put('/update-product/:id', async (req, res) => {
        const { productName, productDescription, productMainImg, productCategory, productMenuCategory, productNewCategory, productPrice, productDiscount } = req.body;
        try {
            ...
            product.menuCategory = (productCategory === 'new category') ? productNewCategory : productMenuCategory;
